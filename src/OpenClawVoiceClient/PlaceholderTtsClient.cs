...
/// </summary>
public sealed class PlaceholderTtsClient : ITtsClient
{
    private readonly ILogger<PlaceholderTtsClient> _logger;

    public PlaceholderTtsClient(ILogger<PlaceholderTtsClient> logger)
    {
        _logger = logger;
    }
